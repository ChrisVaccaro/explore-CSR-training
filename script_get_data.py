...
def main():
    while True:
        # If the WHITE button was pressed then the led will CONTINUE OFF and and all data will be DELETED from the file.
        if button_reset.is_pressed():
            with open('data.csv', 'w', newline='') as file:
                file.truncate()
        
        # If the GREEN button was pressed then the led will LIGHT UP and the data is being SAVED correctly.
